 ...
 */
 ...
 export function createMessage(message) { // add any necessary parameters
   return {
     type: CREATE_MESSAGE,
     message
   }
 ...
 export function setSelectedMessageId(id) { // add any necessary parameters
   return {
 ...
 export const SET_RIGHT_PANE_IS_LOUD = 'SET_RIGHT_PANE_IS_LOUD';
 export function setRightPaneIsLoud(isLoud) {
   return {
     type: SET_RIGHT_PANE_IS_LOUD,
     isLoud
   }
 }
