...
const initialState = {
  ...
  //     between MessagePane and LoudMessagePane). You should use a string for this
  //     instead of storing MessagePane / LoudMessagePane directly in state, because
  //     strings are serializable and the components are not. Redux state should
...
export default function messagesReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case SET_RIGHT_PANE_IS_LOUD:
      return {
        ...state,
        rightPaneIsLoud: action.isLoud
      }
    default:
      return state;
  }
